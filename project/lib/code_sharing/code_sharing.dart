...
import 'package:groupmeet/code_sharing/display_code.dart';
  ...
  void getCode() async {
    ...
    if (snapshot.exists) {
      ...
      for (var keys in type.entries) {
        final snapshot2 =
            await ref.child("groups/${keys.key.toString()}/name").get();
      ...
      Navigator.push(
          context,
          MaterialPageRoute(
              builder: (context) => DisplayCode(groupName, nameId)));
    } else {
      Fluttertoast.showToast(
          msg:
              "You are not apart of any groups! Please create one or add yourself to one",
            ...
            Row(
              ...
              children: [
                ...
                PlatformIconButton(
                  onPressed: getCode,
                  icon: const Icon(
                      size: 30, IconData(0xe050, fontFamily: 'MaterialIcons')),
                ),
              ],
            ),
          ],
